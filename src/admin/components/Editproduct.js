            ...
            <>
                ...
                >
                    <Form className='mt-3 d-flex justify-content-center flex-column'>
                        <div>
                            <Field style={{textAlign:"center"}} class="form-control align-right" placeholder={i.ProductType} name="ProductType" type="text"/>
                            <p className='d-block text-warning h5 mt-4'>
                                <ErrorMessage name="ProductType"/>
                            </p>
                        </div>
                        <div>
                            <Field style={{textAlign:"center"}} class="form-control" placeholder={i.ProductName} name="ProductName" type="text"/>
                            <p className='d-block text-warning h5 mt-4'>
                                <ErrorMessage name="ProductName"/>
                            </p>
                        </div>
                        <div>
                            <Field style={{textAlign:"center"}} class="form-control" placeholder={i.ProductPrice} name="ProductPrice" type="text"/>
                            <p className='d-block text-warning h5 mt-4'>
                                <ErrorMessage name="ProductPrice"/>
                            </p>
                        </div>
                        <div>
                            <Field style={{textAlign:"center"}} class="form-control" placeholder={i.ProductPicture} name="ProductPicture" type="text"/>
                            <p className='d-block text-warning h5 mt-4'>
                                <ErrorMessage name="ProductPicture"/>
                            </p>
                        </div>
                        <div>
                            <Field style={{textAlign:"center"}} class="form-control" placeholder={i.ProductCount} name="ProductCount" type="text"/>
                            <p className='d-block text-warning h5 mt-4'>
