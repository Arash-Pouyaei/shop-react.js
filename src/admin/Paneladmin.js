          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="custom_menu">
                <ul>
                  <li>
                    <a href="#" className='h5 a' style={{marginRight:"10px"}} onClick={a=>{setpaneladminshow(false);setformadminshow(false);}}>Home Page</a>
                    {" "}
                    <a href="#" className='h5 a' style={{marginLeft:"10px"}} onClick={a=>{setpaneladminshow(false);setformadminshow(true);}}>Log Out</a>
                  </li>
                </ul>
              </div>
            </div>
